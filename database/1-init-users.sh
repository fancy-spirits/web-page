...
PGPASSWORD=$POSTGRES_ADMIN_PASSWORD psql -v ON_ERROR_STOP=1 --username "$POSTGRES_ADMIN_USER" --dbname "$POSTGRES_DB" -c "GRANT CONNECT database $POSTGRES_DB TO $POSTGRES_FANCY_SPIRITS_USER;" 
